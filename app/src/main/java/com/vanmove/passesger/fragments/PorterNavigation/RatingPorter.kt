...
import kotlinx.android.synthetic.main.fragment_rating_porter.view.*
import org.json.JSONException
import org.json.JSONObject
import java.util.*

class RatingPorter : Fragment(R.layout.fragment_rating_porter),
    ...
    private fun linkViews() {
        ...
        view!!.tv_driver_name.setText(
            "" + getPreferences(
                CONSTANTS.driver_first_name,
                context!!
            )
        )
        val driver_image_str =
            Utils.imageUrl + getPreferences(
                CONSTANTS.picture,
                context!!
            )
        Picasso.get().load(driver_image_str).into(view!!.driver_image)
    ...
    private fun submitRating() {
        ...
        if (TextUtils.isEmpty(str_rating)) {
            ...
            showToast("please give feedback")
        } else {
            view!!. btn_submit!!.text = "Updating feedback..."
    ...
    private fun updaterating() {
        val porter_id =
            getPreferences(CONSTANTS.porter_id, context!!)
        progressDialog = ProgressDialog.show(
            context, "",
            "Wait please....", true
        )
        val url = Utils.porter_update_request_rating_user
        ...
        Log.d("PorterRating", "PorterId: $porter_id, req: $reqID, rating: $str_rating, feedback: $str_review")
